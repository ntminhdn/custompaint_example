        ...
        children: [
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) => BubbleChat(message: _messages[index]),
            ),
          ),
          Row(
            children: [
...
class MyCustomPainter extends CustomPainter {
  ...
  final bool isMine;
  final Paint bgPaint;
  static const arrowSize = 10;

  @override
  void paint(Canvas canvas, Size size) {
    final width = size.width;
    final height = size.height;
    final rightPoint1 = Offset(width, height / 2 - 5);
    final rightPoint2 = Offset(width + sqrt(pow(10, 2) - pow(5, 2)), height / 2);
    final centerPoint = Offset(width / 2, height / 2);
    final leftPoint1 = centerPoint * 2 - rightPoint1;
    final leftPoint2 = centerPoint * 2 - rightPoint2;

    canvas.drawRRect(
        RRect.fromRectAndRadius(Rect.fromLTRB(0, 0, width, height), const Radius.circular(10)),
        bgPaint);
